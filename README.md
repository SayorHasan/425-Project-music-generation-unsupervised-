...
This project implements a complete symbolic music generation pipeline using the MAESTRO v3.0.0 dataset. We compare three neural architectures:
...
data/
├── raw_midi/
│   └── maestro-v3.0.0/          # Original MAESTRO MIDI files (organized by year)
│       ├── 2004/, 2006/, ..., 2018/
...
**Raw MIDI Files:** Each year folder contains hundreds of performance recordings in MIDI format.  
...
If you use this project or the MAESTRO dataset, please cite:
